...
module all_holes() {
  ...
  translate([-3.15, 0, -15])
    {
      translate([0,15.75-5.25, 0])
        rotate([0,0,90])
          cylinder(h=190,r=1.05);
      translate([0,-5.25-5.25, 0])
        rotate([0,0,90])
          cylinder(h=190,r=1.05);
    }
  translate([29.4, 0, -15])
    {
      translate([0,31.5-5.25, 0])
        rotate([-40,1,90])
          cylinder(h=80,r=.525);
      translate([0,-22.05-5.25, 0])
        rotate([-40,1,90])
          cylinder(h=80,r=.525);
    }
}
